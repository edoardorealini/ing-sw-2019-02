...
public class MapBuilder implements Serializable{
    ...
    */
    ...
    public Map makeMap(int mapID) throws  IOException{
        switch (mapID){
            case 1:
                BufferedReader br1 = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream(File.separatorChar + "maps" + File.separatorChar + "map1.json")));
                map = json.fromJson(br1, Map.class);
                break;
            case 2:
                BufferedReader br2 = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream(File.separatorChar + "maps" + File.separatorChar + "map2.json")));
                map = json.fromJson(br2, Map.class);
                break;
            case 3:
                BufferedReader br3 = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream(File.separatorChar + "maps" + File.separatorChar + "map3.json")));
                map = json.fromJson(br3, Map.class);
                break;
            case 4:
                BufferedReader br4 = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream(File.separatorChar + "maps" + File.separatorChar + "map4.json")));
